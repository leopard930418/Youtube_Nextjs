    ...
    <PageLayout>
      <section className="relative w-full py-16 text-white bg-[#070812]">
        ...
        <div className="text-center">
          <h2 className="flex flex-col items-center gap-[12px] text-center m-[0_0_clamp(22px,4vw,5px)] text-[48px] font-black leading-[.98] tracking-[-0.055em] animate-none bg-clip-text text-transparent" style={{
